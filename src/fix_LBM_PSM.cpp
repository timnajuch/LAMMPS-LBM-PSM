...
void fix_LBM_PSM::post_force(int vflag)
{
  if (update->ntimestep % nevery)
  {
    ...
    if(domain->dimension == 2){
      lbmmpicomm->sendRecvData<double>(dynamics->getVector_f_curr(), 0, dynamics->get_nx(), dynamics->get_ny(), 1, dynamics->get_envelopeWidth(), domain->xperiodic);
      lbmmpicomm->sendRecvData<double>(dynamics->getVector_f_curr(), 1, dynamics->get_nx(), dynamics->get_ny(), 1, dynamics->get_envelopeWidth(), domain->yperiodic);
    }else{
      lbmmpicomm->sendRecvData<double>(dynamics->getVector_f_curr(), 0, dynamics->get_nx(), dynamics->get_ny(), dynamics->get_nz(), dynamics->get_envelopeWidth(), domain->xperiodic);
      lbmmpicomm->sendRecvData<double>(dynamics->getVector_f_curr(), 1, dynamics->get_nx(), dynamics->get_ny(), dynamics->get_nz(), dynamics->get_envelopeWidth(), domain->yperiodic);
      lbmmpicomm->sendRecvData<double>(dynamics->getVector_f_curr(), 2, dynamics->get_nx(), dynamics->get_ny(), dynamics->get_nz(), dynamics->get_envelopeWidth(), domain->zperiodic);
    }
